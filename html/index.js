<link rel="stylesheet" class="aplayer-secondary-style-marker" href="\assets\css\APlayer.min.css"><script src="\assets\js\APlayer.min.js" class="aplayer-secondary-script-marker"></script>var S = {
    init: function() {
        ...
        if (i !== -1) {
            ...
            S.UI.simulate('|#countdown 3||一|诺|生|日|快|乐|I|Love|You|你|就是|我的|小太阳|');
        }
